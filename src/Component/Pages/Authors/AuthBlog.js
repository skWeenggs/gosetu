                  ...
                  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="max-w-2xl mx-auto text-center">
                        ...
                        <ol className="hidden items-center space-x-4 sm:flex">
                          ...
                          <li>
                            <div className="flex items-center">
                              ...
                              <a className="truncate text-sm font-medium text-secondary-500 ml-4 text-left hover:text-secondary-700 ">Authors</a>
                            </div>
                          </li>
                          <li>
                            <div className="flex items-center">
                              ...
                              <a className="truncate text-sm font-medium text-secondary-500 ml-4 text-left hover:text-secondary-700 " >{all?.author?.name}</a>
                            </div>
                          </li>
                        </ol>
                      </nav>
                      <div className="flex flex-col items-center justify-center mt-8 mr-4">
                        ...
                        <p className='text-lg text-center'> {all?.author?.icon?.emoji} </p>
                        {all?.author?.icon?.external?.url ? (<>
                          <img src={all?.author?.icon?.external?.url} alt={all?.author?.icon?.name} className='h-20 w-20 rounded-full ' />
                        </>
                        )
                          :
                          all?.author?.icon?.file?.url ? (
                            <>
                              <img src={all?.author?.icon.file.url} alt="fgd" className='h-5 w-5' />
                            </>
                          ) : ''}
                        {/* <img
                       alt="Paul York"
                       src="https://cdn.feather.blog?src=https%3A%2F%2Fusenotioncms.com%2Fproxy%2Fblock%2F51bd1d16-cec2-4d9a-b2b9-e5facf0ad3a5%252Fedb10040-d0d6-4b51-85c4-0c4c28767a3b%252Fphoto.png&amp;optimizer=image"
                       className="inline-block h-16 w-16 flex-shrink-0 object-cover rounded-full lg:h-24 lg:w-24"
                   /> */}
                        <h1 className="text-3xl font-bold tracking-tight text-secondary-900 mt-5 sm:text-4xl lg:text-5xl"></h1>
                      </div>
